    ...
    def forward(self, input_ids, attention_mask, seg_encoding, context2token_masks, token_masks, targets=None, tgt_seq_ids=None, tgt_seq_len=None, relID2triples=None,
        ...
        if targets is not None:
            ...
            if not gen:
                ...
                state = State(input_ids, h_token, attention_mask, project_triple, rel_indices=rel_indices, relID2triples=relID2triples)
                ...
                state.concat_context_triples(h_triples=h_triples)
            ...
            state = State(input_ids, h_token, attention_mask, project_triple)
    ...
    def predict(self, input_ids, attention_mask, seg_encoding, context2token_masks, token_masks, info, gen):
        with torch.no_grad():
            ...
            if gen:
                ...
                # gen_seq = self.decoder.beam_search_generate(state, num_beams=2)
                # print(gen_seq)
                res = self.decoder.decode_tree(gen_seq, triples_, info)
