        ...
        if evaluate:
            ...
            for token_id in token_ids:
                if token_id in structure_token_mapping:
                    ...
                    rel_id = token_id - ori_vocab_size
                    head, rel, tail = triples[rel_id]
                    tail_ent_indice = list(range(num_structure_tokens + char_to_bep[tail[0]], num_structure_tokens + char_to_bep[tail[1]-1]+1))
                    tgt_seq_ids += tail_ent_indice
